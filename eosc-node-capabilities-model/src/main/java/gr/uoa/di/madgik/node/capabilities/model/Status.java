...
/**
 * Suggested status values for a capability.
 *
 * <p>This enum documents the known and recommended status values used by the application.
 * It is not a closed vocabulary for persisted or incoming data. {@link Capability} stores
 * {@code status} as a {@link String}, so values outside this enum are still accepted in order
